...
<head>
	...
	<title>Coffee Shop - checkout page</title>
</head>
...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="/">home </a><span>/ checkout summary</span>
		</div>
		<section class="checkout">
			<div class="title">
				<img src="img/coffee_logo.png" class="logo">
				<h1>checkout summary</h1>
				<p>Review your selections and total cost below. Confirm your order details and proceed to secure payment. Thank you for choosing Coffee Co. for your coffee needs!
				</p>
			</div>
			<div class="row">
				<form method="post">
