	...
	<div class="main-container">
		<section class="form-container">
			<div class="title">
				...
				<h1>login now</h1>
				<p>Access exclusive member benefits and personalize your Coffee Co. experience. Log in now to manage your preferences, track orders, and receive updates on special offers. Your next coffee adventure awaits!
				</p>
			</div>
