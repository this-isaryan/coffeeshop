...
<body style="padding-left: 0 !important;">
	...
	<div class="main">
		...
		<div class="title2">
			<a href="/greenCoffee">home </a><span>/ update profile</span>
		</div>
		<section>
			<?php
			if (isset($message)) {
			...
			<div class="form-container" id="admin_login">
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="input-field">
						...
						<input type="email" name="email" maxlength="50" placeholder="Enter your username" oninput="this.value.replace(/\s/g,'')" value="<?= $fetch_profile['email']; ?>">
					</div>
					<div class="input-field">
