	...
	<div class="main">
		...
		<section class="orders">
			<div class="title">
				...
				<h1>my orders</h1>
				<p>View and manage all your orders here. Whether you're tracking your latest coffee delivery or reviewing past purchases, everything you need is right at your fingertips. Start by placing your first order today!
				</p>
			</div>
